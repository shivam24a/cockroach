...
func TestLineCrossingDirection(t *testing.T) {
	testCases := []struct {
		...
		{
			desc:     "Two point lines with short lenght, line1 vertical, line2 horizontal crossing toward left",
		...
		{
			desc:     "Two point lines with short lenght, line1 horizontal, line2 vertical crossing toward right",
		...
		{
			desc:     "Two point lines with short lenght, line1 vertical, line2 horizontal crossing toward right",
		...
		{
			desc:     "Two point lines with short lenght, line1 horizontal, line2 vertical crossing toward left",
			line1:    geom.NewLineStringFlat(geom.XY, []float64{-0.0025, 0, 0.0025, 0}),
			line2:    geom.NewLineStringFlat(geom.XY, []float64{0, -0.1, 0, 0.005}),
			expected: LineCrossLeft,
		},
		{
			desc:     "Two point lines with short lenght, line1 horizontal, line2 vertical toward left but no crossing",
		...
		{
			desc:     "Two point lines with short lenght, line1 vertical, line2 horizontal toward right but no crossing",
